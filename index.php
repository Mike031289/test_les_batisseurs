    ...
    <div class="collapse navbar-collapse pt-3 ml-5" id="navbarTogglerDemo03">
      ...
      <div  class="container-fluid">
        ...
        <section id="contact" class="row">
          <h1 id="nousContacter" class="col-lg-12 ext-center">QUI SOMMES NOUS</h1>
            <div class="row form_contact pt-5">
              <div class="col-lg">
                <h2 id="apropos" class="">Nos Objetifs</h2>
                <p>
                  Nous sommes une Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus sequi autem odio veniam ipsum repudiandae ut cumque maxime itaque laboriosam tempore rerum aperiam impedit provident blanditiis vel illo, error labore. Nous sommes une Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus sequi autem odio veniam ipsum repudiandae ut cumque maxime itaque laboriosam tempore rerum aperiam impedit provident blanditiis vel illo, error labore.
                ...
                <div id="contactForm" class="card col-lg m-5" >
                    <img src="src/img/slider/slider1.jpg" class="col-lg p-4" alt="image d'ilustration">
                  </div>
                </div>
            </div>
            </div>
          ...
          <div id="index-cards_Block" class="card text-white">
            ...
            <div class="card  text-dark text-center">
              <h1 class="text-dark p-5 mt-5 text-center">Nos nouveatés</h1>
                  <h5 class="card-title pt-5">Chocolats Pralinés</h5>
                    <p class="card-text pb-5">
                        <strong>Lorem ipsum dolor  </strong> et
        ...
        <div id="plus-d-information" class="">
        <p>
          * Nous vous rassurons de la confidentialité
          <strong>les cookies</strong>, vous pouvez les
          <strong><a href="#" >Paramétrer vos cookies</a></strong>. Politique de protection des données personnelles  Gérer vos données personnelles  Accessibilité : partiellement conforme  Alerte de sécurité  Pièces détachées  Rappel Produits  Magasins  CG Carte
        </p>
        <p>
          <em
            > </em
